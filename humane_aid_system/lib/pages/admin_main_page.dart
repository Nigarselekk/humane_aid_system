        ...
        onPressed: () async {
          ...
          if (response.succeeded == true) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text(
                    'Failed to update aid point status: ${response.message}'),
                backgroundColor: Colors.red,
              ),
            );
          }
    ...
    actions: [
      ...
      TextButton(
        onPressed: () async {
          ...
          // log(Me.instance.myInfo.jwToken.toString());
          final response = await addHelpPoint(
              Me.instance.myInfo.jwToken.toString(),
              name,
              location,
              status,
              latitude,
...
Future<BaseModel<int>> addHelpPoint(String token, String name, String location,
